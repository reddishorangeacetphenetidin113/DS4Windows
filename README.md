...
3. Download the zip file provided in the assets section.
4. Extract the folder to a location on your computer. Keep this folder in a safe place.
5. Open the folder and locate the executable file. 
6. Run the file to start the main menu.
...
2. Click "New" to create a fresh profile.
3. Select "Edit" to change your button layout.
4. You can map any button on your PlayStation controller to any button on an Xbox controller. 
5. Select "Save" when your layout looks right.
...
2. Unplug your controller and plug it back in.
3. Check if the ViGEmBus driver appears in your Windows Device Manager.
